  ...
  Future<String> uploadFile() async {
    try {
      var snapshot = await FirebaseStorage.instance
          .ref(
              'Subscription Attachment/${DateTime.now().millisecondsSinceEpoch}')
                  ...
                  return Container(
                    width: MediaQuery.of(context).size.width < 1275
                        ...
                        : MediaQuery.of(context).size.width -
                            240, // width: context.width() < 1080 ? 1080 - 240 : MediaQuery.of(context).size.width - 240,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        RichText(
                                          ...
                                          text: TextSpan(
                                            ...
                                            children: const <TextSpan>[
                                              ...
                                              TextSpan(
                                                  text:
                                                      ' বাটন প্রেস করে উক্ত ফরমে আপনার শপের ইমেইল ও নামের জায়গায় শপের নাম দিয়ে পেমেন্ট করতে পারবেন।'),
                                            ],
                                          ),
                                        ),
                                        const SizedBox(height: 10),
                                        RichText(
                                          ...
                                          text: TextSpan(
                                            text:
                                                'এক বছরের প্ল্যান ক্রয় করতে ',
                                            style: const TextStyle(
                                              fontSize: 17,
                                            ),
                                            children: const <TextSpan>[
                                              TextSpan(
                                                  text: 'PAY YEARLY WITH BKASH',
                                                  style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.bold,
                                                      color: Colors.orange)),
                                              TextSpan(
                                                  text:
                                                      ' বাটনে ক্লিক করে উক্ত ফরমে আপনার শপের ইমেইল ও নামের জায়গায় শপের নাম দিয়ে পেমেন্ট করতে পারবেন।'),
                                            ],
                                          ),
                                        ),
                                        const SizedBox(height: 10),
                                            ...
                                            onPressed: (clickNormal ||
                                                ...
                                                : () async {
                                                    ...
                                                    EasyLoading.show(
                                                        status: 'Loading...');
                                                    String yearlyUrl =
                                                        "https://shop.bkash.com/pix-store01752156079/pay/bdt2999/rD0hia";
                                                    await htmls.window.open(
                                                        yearlyUrl, '_blank');
                                                    EasyLoading.dismiss();
                                                    String? sellerUserRef =
                                                        await getSaleID(
                                          ...
                                          child: ElevatedButton(
                                            ...
                                            onPressed: (clickNormal ||
                                                ...
                                                : () async {
                                                    ...
                                                    String monthUrl =
                                                        "https://shop.bkash.com/pix-store01752156079/pay/bdt349/kl70VR";
                                                    ...
                                                    try {
                                                      ...
                                                      EasyLoading.dismiss();
                                                      EasyLoading.showError(
                                                          'Could not launch, please try later.');
                                                    }
...
class SubscriptionRequestModel {
  ...
  Map<dynamic, dynamic> toJson() => <dynamic, dynamic>{
        ...
        'subscriptionPrice': subscriptionPlanModel.offerPrice > 0
            ? subscriptionPlanModel.offerPrice
            : subscriptionPlanModel.subscriptionPrice,
