...
class _ShowPaymentPopUpState extends State<ShowPaymentPopUp> {
  ...
  SaleTransactionModel checkLossProfit({required SaleTransactionModel transitionModel}) {
    ...
    for (var element in transitionModel.productList!) {
      ...
      totalQuantity =totalQuantity +  int.parse(element.quantity.toString());
    }
                                            ...
                                            child: TextFormField(
                                              ...
                                              onChanged: (value) {
                                                setState(() {
                                                  ...
                                                  if (paidAmount > (widget.transitionModel.totalAmount ?? 0)) {
                                                    changeAmountController.text = (paidAmount - (widget.transitionModel.totalAmount?? 0)).toString();
                                                    dueAmountController.text = '0';
                                                  } else {
                                                    dueAmountController.text = ((widget.transitionModel.totalAmount?? 0) - paidAmount).abs().toStringAsFixed(2);
                                                    changeAmountController.text = '0';
                                                  }
                                                });
                                              },
