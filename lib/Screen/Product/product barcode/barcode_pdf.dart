                  ...
                  pw.Padding(
                    ...
                    child: pw.Container(
                        ...
                        child: pw.Column(
                          ...
                          children: [
                            site?
                            pw.Text(personalInformation.companyName,style: pw.Theme.of(context).defaultTextStyle.copyWith(color: PdfColors.black, fontWeight: pw.FontWeight.normal,fontSize: 10),): pw.Text(''),
                            name?
                            pw.Text(product.productName.toString(),style: pw.Theme.of(context).defaultTextStyle.copyWith(color: PdfColors.black, fontWeight: pw.FontWeight.normal,fontSize: 8),): pw.Text(''),
                            price?
                            pw.Text(
                              '$currency.${product.productPurchasePrice}',
                              style: pw.Theme.of(context).defaultTextStyle.copyWith(color: PdfColors.black, fontWeight: pw.FontWeight.bold,fontSize: 10),
                            ): pw.Text(''),
                            pw.BarcodeWidget(
