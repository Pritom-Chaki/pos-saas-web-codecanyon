...
class _SalesReturnScreenState extends State<SalesReturnScreen> {
  ...
  Future<void> saleReturn(
      ...
      required SaleTransactionModel orginal,
                                                                ...
                                                                children: [
                                                                  ...
                                                                  SizedBox(
                                                                    ...
                                                                    child:
                                                                        TextFormField(
                                                                      initialValue:
                                                                          myFormat.format(double.tryParse(returnList[index].subTotal) ??
                                                                              0),
                                                                      onChanged:
                                                                          (value) {
                                                                        if (value ==
                                                                  ...
                                                                  SizedBox(
                                                                    ...
                                                                    child: Text(
                                                                      myFormat.format(
                                                                          double.tryParse((double.parse(returnList[index].subTotal) * ((returnList[index].stock ?? 0) - returnList[index].quantity)).toStringAsFixed(2)) ??
                                                                              0),
                                                                      style: kTextStyle.copyWith(
                                                                          color:
                                                                              kTitleColor),
                                                    ...
                                                    onTap: () async {
                                                      if (!returnList.any(
                                                        ...
                                                        for (var p in widget
                                                          ...
                                                          debugPrint(
                                                              "------ 00>>>>newProductList ${newProductList.length}");
                                                          if (p.quantity > 0)
                                                            newProductList
                                                                .add(p);
                                                        }
                                                        ...
                                                        await FirebaseDatabase
                                                            ...
                                                            .then((value) {
                                                          debugPrint(
                                                              "------ 1>>>>value.children ${value.children.length}");
                                                          for (var element
                                                              in value
                                                                  .children) {
                                                            ...
                                                            debugPrint(
                                                                "------ 2>>>>t $t");
                                                            debugPrint(
                                                                "------ 3>>>>invoiceNumber ${editedTransitionModel.invoiceNumber}");
                                                            debugPrint(
                                                                "------ 4>>>>invoiceNumber ${t.invoiceNumber}");
                                                        ...
                                                        if (newProductList
                                                            .isEmpty) {
                                                          debugPrint(
                                                              "------ 6>>>>newProductList ${newProductList.length}");
                                                          await FirebaseDatabase
                                                              .instance
                                                              .ref(userId)
                                                              .child(
                                                          ...
                                                          debugPrint(
                                                              "------ 7>>>>newProductList ${newProductList.length}");
                                                          num totalQuantity = 0;
                                                          double lossProfit = 0;
                                                          double
                                                              totalPurchasePrice =
