...
import 'package:salespro_admin/payment/payment/screens/payment_bkash_screen.dart';
        ...
        child: Builder(
            builder: (context) => MaterialApp(
                  ...
                  routes: {
                    ...
                    PaymentBkashScreen.route: (context) => PaymentBkashScreen(
                          bKashURL: ModalRoute.of(context)!.settings.arguments.toString(),
                        ),
